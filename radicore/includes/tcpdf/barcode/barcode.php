...
//
// This version contains changes by A J Marston
//  - integration with Radicore framework (htp://www.radicore.org)
//============================================================+
 ...
 * set default margin
 */
//define("BCD_DEFAULT_MAR_Y1", 0);  // AJM
define("BCD_DEFAULT_MAR_Y1", 5);  // AJM

/**
 * set default margin
 */
//define("BCD_DEFAULT_MAR_Y2", 0);  // AJM
define("BCD_DEFAULT_MAR_Y2", 5);  // AJM
