 ...
 */
//require_once(dirname(__FILE__).'/config/tcpdf_config.php');  // AJM
require_once('tcpdf_config.php');  // AJM
...
if(!class_exists('TCPDF', false)) {
	 ...
	 */
	define('PDF_PRODUCER','TCPDF 1.53.0.TC033 (http://tcpdf.sourceforge.net)');
	...
	class TCPDF {
		...
		*/
		...
		public function writeBarcode($x, $y, $w, $h, $type, $style, $font, $xres, $code) {
			...
			//require_once(dirname(__FILE__)."/barcode/i25object.php");  // AJM
			//require_once(dirname(__FILE__)."/barcode/c39object.php");  // AJM
			//require_once(dirname(__FILE__)."/barcode/c128aobject.php");  // AJM
			//require_once(dirname(__FILE__)."/barcode/c128bobject.php");  // AJM
			//require_once(dirname(__FILE__)."/barcode/c128cobject.php");  // AJM
			...
			//$scale_factor = 1.5 * $xres * $this->k;  // AJM
			$scale_factor = 1.5 * $this->k;  // AJM
