...
$sql_select = 'crs_student.student_id, crs_student.first_name, crs_student.last_name, crs_student.initials, crs_student.year, '
...
$sql_where  = '';
$sql_groupby = 'crs_student.student_id, crs_student.first_name, crs_student.last_name, crs_student.initials, crs_student.year';
