-- file created on August 6, 2007, 11:14 am
...
REPLACE INTO `mnu_nav_button` (`task_id_snr`, `task_id_jnr`, `sort_seq`, `button_text`, `context_preselect`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES 
('wf_arc(list)', 'wf_arc(del)', '004', 'Delete', 'Y', '2004-04-12 19:25:58', 'AJM', '2004-04-12 19:26:19', 'AJM');
...
REPLACE INTO `mnu_nav_button` (`task_id_snr`, `task_id_jnr`, `sort_seq`, `button_text`, `context_preselect`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES 
('wf_arc(list)', 'wf_arc(enq)', '002', 'Read', 'Y', '2004-04-12 19:25:58', 'AJM', '2004-04-12 19:26:19', 'AJM');
...
REPLACE INTO `mnu_task` (`task_id`, `task_desc`, `button_text`, `task_type`, `script_id`, `is_disabled`, `pattern_id`, `subsys_id`, `initial_passthru`, `selection_fixed`, `selection_temp`, `settings`, `order_by`, `keep_data`, `log_sql_query`, `screen_refresh`, `use_https`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES 
('wf_arc(list)', 'List Workflow Arc', 'Arc', 'PROC', 'arc.list.php', 'N', 'LIST2', 'WORKFLOW', NULL, NULL, NULL, NULL, 'place_type,place_id', 'N', 'N', NULL, 'N', '2004-04-12 19:21:28', 'AJM', '2007-03-20 18:07:46', 'AJM');

REPLACE INTO `mnu_nav_button` (`task_id_snr`, `task_id_jnr`, `sort_seq`, `button_text`, `context_preselect`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES 
('wf_arc(list)', 'wf_arc(add)', '001', 'New', 'N', '2004-04-12 19:25:58', 'AJM', '2004-04-12 19:26:19', 'AJM'),
('wf_arc(list)', 'wf_arc(enq)', '002', 'Read', 'Y', '2004-04-12 19:25:58', 'AJM', '2004-04-12 19:26:19', 'AJM'),
('wf_arc(list)', 'wf_arc(upd)', '003', 'Update', 'Y', '2004-04-12 19:25:58', 'AJM', '2004-04-12 19:26:19', 'AJM'),
('wf_arc(list)', 'wf_arc(del)', '004', 'Delete', 'Y', '2004-04-12 19:25:58', 'AJM', '2004-04-12 19:26:19', 'AJM'),
('wf_arc(list)', 'wf_arc(search)', '005', 'Search', 'N', '2004-04-12 19:25:58', 'AJM', '2004-04-12 19:26:19', 'AJM'),
('wf_arc(list)', 'audit_dtl(list)3', '006', 'Audit Trail', 'Y', '2004-04-12 19:26:31', 'AJM', NULL, NULL);

REPLACE INTO `mnu_nav_button` (`task_id_snr`, `task_id_jnr`, `sort_seq`, `button_text`, `context_preselect`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES 
('wf_workflow(list)', 'wf_arc(list)', '009', 'Arcs', 'Y', '2004-04-12 19:27:07', 'AJM', '2004-04-26 14:41:27', 'AJM');
...
REPLACE INTO `mnu_task` (`task_id`, `task_desc`, `button_text`, `task_type`, `script_id`, `is_disabled`, `pattern_id`, `subsys_id`, `initial_passthru`, `selection_fixed`, `selection_temp`, `settings`, `order_by`, `keep_data`, `log_sql_query`, `screen_refresh`, `use_https`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES 
('wf_case(list)2', 'List Case within Workflow', 'Cases', 'PROC', 'case.list2.php', 'N', 'LIST2', 'WORKFLOW', NULL, NULL, NULL, NULL, 'case_id', 'N', 'N', NULL, 'N', '2004-04-26 14:03:18', 'AJM', '2007-03-20 18:08:02', 'AJM');

REPLACE INTO `mnu_nav_button` (`task_id_snr`, `task_id_jnr`, `sort_seq`, `button_text`, `context_preselect`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES 
('wf_case(list)2', 'wf_case(enq)', '001', 'Read', 'Y', '2004-04-26 14:47:11', 'AJM', NULL, NULL),
('wf_case(list)2', 'wf_case(search)', '002', 'Search', 'N', '2004-04-26 14:47:11', 'AJM', NULL, NULL),
...
REPLACE INTO `mnu_nav_button` (`task_id_snr`, `task_id_jnr`, `sort_seq`, `button_text`, `context_preselect`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES 
('wf_workflow(list)', 'wf_case(list)2', '012', 'Cases', 'Y', '2004-04-26 14:12:30', 'AJM', '2004-04-26 14:14:18', 'AJM');
...
REPLACE INTO `mnu_nav_button` (`task_id_snr`, `task_id_jnr`, `sort_seq`, `button_text`, `context_preselect`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES 
('wf_place(list)', 'wf_place(del)', '004', 'Delete', 'Y', '2004-04-12 18:57:46', 'AJM', '2004-04-12 18:58:12', 'AJM');
...
REPLACE INTO `mnu_nav_button` (`task_id_snr`, `task_id_jnr`, `sort_seq`, `button_text`, `context_preselect`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES 
('wf_place(list)', 'wf_place(enq)', '002', 'Read', 'Y', '2004-04-12 18:57:46', 'AJM', '2004-04-12 18:58:12', 'AJM');

REPLACE INTO `mnu_role_task` (`role_id`, `task_id`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES 
('DEMO', 'wf_place(enq)', '2005-04-19 18:13:52', 'AJM', NULL, NULL);

REPLACE INTO `mnu_task` (`task_id`, `task_desc`, `button_text`, `task_type`, `script_id`, `is_disabled`, `pattern_id`, `subsys_id`, `initial_passthru`, `selection_fixed`, `selection_temp`, `settings`, `order_by`, `keep_data`, `log_sql_query`, `screen_refresh`, `use_https`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES 
('wf_place(list)', 'List Workflow Place', 'Place', 'PROC', 'place.list.php', 'N', 'LIST2', 'WORKFLOW', NULL, NULL, NULL, NULL, 'place_type,place_id', 'N', 'N', NULL, 'N', '2004-04-12 18:51:05', 'AJM', '2007-03-20 18:08:08', 'AJM');

REPLACE INTO `mnu_nav_button` (`task_id_snr`, `task_id_jnr`, `sort_seq`, `button_text`, `context_preselect`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES 
('wf_place(list)', 'wf_place(add)', '001', 'New', 'N', '2004-04-12 18:57:46', 'AJM', '2004-04-12 19:06:49', 'AJM'),
('wf_place(list)', 'wf_place(enq)', '002', 'Read', 'Y', '2004-04-12 18:57:46', 'AJM', '2004-04-12 18:58:12', 'AJM'),
('wf_place(list)', 'wf_place(upd)', '003', 'Update', 'Y', '2004-04-12 18:57:46', 'AJM', '2004-04-12 18:58:12', 'AJM'),
('wf_place(list)', 'wf_place(del)', '004', 'Delete', 'Y', '2004-04-12 18:57:46', 'AJM', '2004-04-12 18:58:12', 'AJM'),
('wf_place(list)', 'wf_place(search)', '005', 'Search', 'N', '2004-04-12 18:57:46', 'AJM', '2004-04-12 18:58:12', 'AJM'),
('wf_place(list)', 'audit_dtl(list)3', '006', 'Audit Trail', 'Y', '2004-04-12 19:01:02', 'AJM', NULL, NULL);

REPLACE INTO `mnu_nav_button` (`task_id_snr`, `task_id_jnr`, `sort_seq`, `button_text`, `context_preselect`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES 
('wf_workflow(list)', 'wf_place(list)', '008', 'Places', 'Y', '2004-04-12 18:59:27', 'AJM', '2004-04-26 14:41:27', 'AJM');
...
('wf_token(list)', 'wf_token(enq)', '002', 'Read', 'Y', '2004-04-25 12:45:41', 'AJM', '2004-04-25 12:45:47', 'AJM');
...
REPLACE INTO `mnu_task` (`task_id`, `task_desc`, `button_text`, `task_type`, `script_id`, `is_disabled`, `pattern_id`, `subsys_id`, `initial_passthru`, `selection_fixed`, `selection_temp`, `settings`, `order_by`, `keep_data`, `log_sql_query`, `screen_refresh`, `use_https`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES 
('wf_token(list)2', 'List Token within Case', 'Tokens', 'PROC', 'token.list2.php', 'N', 'LIST2', 'WORKFLOW', NULL, NULL, NULL, NULL, 'case_id', 'N', 'N', NULL, 'N', '2004-04-26 15:01:10', 'AJM', '2007-03-20 18:08:13', 'AJM');

REPLACE INTO `mnu_nav_button` (`task_id_snr`, `task_id_jnr`, `sort_seq`, `button_text`, `context_preselect`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES 
('wf_token(list)2', 'wf_token(enq)', '001', 'Read', 'Y', '2004-04-26 15:11:37', 'AJM', NULL, NULL),
('wf_token(list)2', 'wf_token(search)', '002', 'Search', 'N', '2004-04-26 15:11:37', 'AJM', NULL, NULL);
...
REPLACE INTO `mnu_nav_button` (`task_id_snr`, `task_id_jnr`, `sort_seq`, `button_text`, `context_preselect`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES 
('wf_transition(list)', 'wf_transition(del)', '004', 'Delete', 'Y', '2004-04-11 19:45:56', 'AJM', '2004-04-11 19:53:13', 'AJM');
...
REPLACE INTO `mnu_nav_button` (`task_id_snr`, `task_id_jnr`, `sort_seq`, `button_text`, `context_preselect`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES 
('wf_transition(list)', 'wf_transition(enq)', '002', 'Read', 'Y', '2004-04-11 19:45:56', 'AJM', '2004-04-11 19:53:13', 'AJM');

REPLACE INTO `mnu_role_task` (`role_id`, `task_id`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES 
('DEMO', 'wf_transition(enq)', '2005-04-19 18:14:07', 'AJM', NULL, NULL);

REPLACE INTO `mnu_task` (`task_id`, `task_desc`, `button_text`, `task_type`, `script_id`, `is_disabled`, `pattern_id`, `subsys_id`, `initial_passthru`, `selection_fixed`, `selection_temp`, `settings`, `order_by`, `keep_data`, `log_sql_query`, `screen_refresh`, `use_https`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES 
('wf_transition(list)', 'List Workflow Transition', 'Transition', 'PROC', 'transition.list.php', 'N', 'LIST2', 'WORKFLOW', NULL, NULL, NULL, NULL, 'transition_id', 'N', 'N', NULL, 'N', '2004-04-11 19:15:08', 'AJM', '2007-03-20 18:08:18', 'AJM');

REPLACE INTO `mnu_nav_button` (`task_id_snr`, `task_id_jnr`, `sort_seq`, `button_text`, `context_preselect`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES 
('wf_transition(list)', 'wf_transition(add)', '001', 'New', 'N', '2004-04-11 19:52:12', 'AJM', '2004-04-11 20:18:44', 'AJM'),
('wf_transition(list)', 'wf_transition(enq)', '002', 'Read', 'Y', '2004-04-11 19:45:56', 'AJM', '2004-04-11 19:53:13', 'AJM'),
('wf_transition(list)', 'wf_transition(upd)', '003', 'Update', 'Y', '2004-04-11 19:45:56', 'AJM', '2004-04-11 19:53:13', 'AJM'),
('wf_transition(list)', 'wf_transition(del)', '004', 'Delete', 'Y', '2004-04-11 19:45:56', 'AJM', '2004-04-11 19:53:13', 'AJM'),
('wf_transition(list)', 'wf_transition(search)', '005', 'Search', 'N', '2004-04-11 19:45:56', 'AJM', '2004-04-11 19:53:13', 'AJM'),
('wf_transition(list)', 'audit_dtl(list)3', '006', 'Audit Trail', 'Y', '2004-04-12 19:01:54', 'AJM', NULL, NULL);

REPLACE INTO `mnu_nav_button` (`task_id_snr`, `task_id_jnr`, `sort_seq`, `button_text`, `context_preselect`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES 
('wf_workflow(list)', 'wf_transition(list)', '007', 'Transitions', 'Y', '2004-04-11 19:15:43', 'AJM', '2004-04-26 14:41:27', 'AJM');
...
REPLACE INTO `mnu_nav_button` (`task_id_snr`, `task_id_jnr`, `sort_seq`, `button_text`, `context_preselect`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES 
('wf_workflow(list)', 'wf_workflow(del)', '004', 'Delete', 'Y', '2004-04-04 00:00:30', 'AJM', '2004-04-04 00:00:54', 'AJM');
...
REPLACE INTO `mnu_nav_button` (`task_id_snr`, `task_id_jnr`, `sort_seq`, `button_text`, `context_preselect`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES 
('wf_workflow(list)', 'wf_workflow(enq)', '002', 'Read', 'Y', '2004-04-04 00:00:30', 'AJM', '2004-04-04 00:00:54', 'AJM');
...
('wf_workflow(list)', 'wf_workflow(add)', '001', 'New', 'N', '2004-04-04 00:00:30', 'AJM', NULL, NULL),
('wf_workflow(list)', 'wf_workflow(enq)', '002', 'Read', 'Y', '2004-04-04 00:00:30', 'AJM', '2004-04-04 00:00:54', 'AJM'),
('wf_workflow(list)', 'wf_workflow(upd)', '003', 'Update', 'Y', '2004-04-04 00:00:30', 'AJM', '2004-04-04 00:00:55', 'AJM'),
('wf_workflow(list)', 'wf_workflow(del)', '004', 'Delete', 'Y', '2004-04-04 00:00:30', 'AJM', '2004-04-04 00:00:54', 'AJM'),
('wf_workflow(list)', 'wf_workflow(search)', '005', 'Search', 'N', '2004-04-04 00:00:30', 'AJM', '2004-04-04 00:00:54', 'AJM'),
('wf_workflow(list)', 'wf_workflow(validate)', '006', 'Validate', 'Y', '2004-04-16 20:18:58', 'AJM', '2004-04-26 14:41:27', 'AJM'),
('wf_workflow(list)', 'wf_transition(list)', '007', 'Transitions', 'Y', '2004-04-11 19:15:43', 'AJM', '2004-04-26 14:41:27', 'AJM'),
('wf_workflow(list)', 'wf_place(list)', '008', 'Places', 'Y', '2004-04-12 18:59:27', 'AJM', '2004-04-26 14:41:27', 'AJM'),
('wf_workflow(list)', 'wf_arc(list)', '009', 'Arcs', 'Y', '2004-04-12 19:27:07', 'AJM', '2004-04-26 14:41:27', 'AJM'),
...
('wf_workitem(list)expired', 'wf_workitem(enq)', '001', 'Read', 'Y', '2007-08-05 16:17:49', 'AJM', NULL, NULL),
...
REPLACE INTO `mnu_task` (`task_id`, `task_desc`, `button_text`, `task_type`, `script_id`, `is_disabled`, `pattern_id`, `subsys_id`, `initial_passthru`, `selection_fixed`, `selection_temp`, `settings`, `order_by`, `keep_data`, `log_sql_query`, `screen_refresh`, `use_https`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES 
('wf_workitem(list)2', 'List Workitem within Case', 'WorkItems', 'PROC', 'workitem.list2.php', 'N', 'LIST2', 'WORKFLOW', NULL, NULL, NULL, NULL, 'workitem_id', 'N', 'N', NULL, 'N', '2004-04-26 15:01:56', 'AJM', '2007-03-20 18:08:23', 'AJM');
...
REPLACE INTO `mnu_task` (`task_id`, `task_desc`, `button_text`, `task_type`, `script_id`, `is_disabled`, `pattern_id`, `subsys_id`, `initial_passthru`, `selection_fixed`, `selection_temp`, `settings`, `order_by`, `keep_data`, `log_sql_query`, `screen_refresh`, `use_https`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES 
('wf_workitem(list)expired', 'List Expired Workitems', 'Expired Workitems', 'PROC', 'workitem.list(expired).php', 'N', 'LIST1', 'WORKFLOW', NULL, NULL, NULL, NULL, 'case_id,workitem_id', 'Y', 'N', NULL, 'N', '2007-08-05 16:15:54', 'AJM', '2007-08-06 11:14:32', 'AJM');

REPLACE INTO `mnu_nav_button` (`task_id_snr`, `task_id_jnr`, `sort_seq`, `button_text`, `context_preselect`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES 
('wf_workitem(list)expired', 'wf_workitem(enq)', '001', 'Read', 'Y', '2007-08-05 16:17:49', 'AJM', NULL, NULL),
('wf_workitem(list)expired', 'wf_workitem(search)', '002', 'Search', 'N', '2007-08-05 16:18:02', 'AJM', NULL, NULL),
('wf_workitem(list)expired', 'wf_workitem(upd)expired', '003', 'Trigger', 'Y', '2007-08-05 16:57:18', 'AJM', '2007-08-06 10:57:28', 'AJM');
...
REPLACE INTO `mnu_task` (`task_id`, `task_desc`, `button_text`, `task_type`, `script_id`, `is_disabled`, `pattern_id`, `subsys_id`, `initial_passthru`, `selection_fixed`, `selection_temp`, `settings`, `order_by`, `keep_data`, `log_sql_query`, `screen_refresh`, `use_https`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES 
('wf_workitem(upd)expired', 'Trigger Expired Workitem', 'Trigger', 'PROC', 'workitem.upd(expired).php', 'N', 'UPD1', 'WORKFLOW', NULL, NULL, NULL, NULL, NULL, 'N', 'N', NULL, 'N', '2007-08-05 16:56:56', 'AJM', NULL, NULL);
...
('workflow', 'wf_case(list)', '002', 'Case', '2004-04-25 10:48:48', 'AJM', NULL, NULL),
('workflow', 'wf_token(list)', '003', 'Token', '2004-04-25 12:11:33', 'AJM', NULL, NULL),
('workflow', 'wf_workitem(list)', '004', 'Workitem', '2004-04-25 13:02:43', 'AJM', NULL, NULL),
('workflow', 'wf_workitem(list)expired', '005', 'Expired Workitems', '2007-08-05 16:17:04', 'AJM', NULL, NULL);

REPLACE INTO `mnu_menu` (`menu_id`, `task_id_jnr`, `sort_seq`, `button_text`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES 
('main_menu', 'workflow', '003', 'Workflow', '2004-04-25 10:39:55', 'AJM', '2005-06-12 12:17:52', 'AJM');

REPLACE INTO `help_text` (`task_id`, `help_text`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES 
('wf_arc(add)', 'This will allow a record to be added to the WF_ARC table for a selected WORKFLOW.

Refer to <a href=\"%root%/wf_arc(add).html\">Add Workflow Arc</a> for full details.', '2005-07-02 16:19:06', 'AJM', NULL, NULL),
('wf_arc(del)', 'This will display a record from the WF_ARC table and allow it to be deleted.

Refer to <a href=\"%root%/wf_arc(del).html\">Delete Workflow Arc</a> for full details.', '2005-07-02 16:27:14', 'AJM', NULL, NULL),
('wf_arc(enq)', 'This will display the contents of a record from the WF_ARC table.

Refer to <a href=\"%root%/wf_arc(enq).html\">Enquire Workflow Arc</a> for full details.', '2005-07-02 16:55:28', 'AJM', NULL, NULL),
('wf_arc(list)', 'This will list records on the WF_ARC table for a selected WORKFLOW.

Refer to <a href=\"%root%/wf_arc(list).html\">List Workflow Arc</a> for full details.', '2005-07-02 16:04:44', 'AJM', NULL, NULL),
('wf_arc(search)', 'This will allow search criteria to be entered for the WF_ARC table.
...
('wf_transition(enq)', 'This will display the contents of a record from the WF_TRANSITION table.
...
('wf_transition(list)', 'This will list records on the WF_TRANSITION table for a selected WORKFLOW.
...
('wf_transition(popup)', 'This will list records on the WF_TRANSITION table and allow one or more to be selected.
...
('wf_transition(search)', 'This will allow search criteria to be entered for the WF_TRANSITION table.
...
('wf_transition(upd)', 'This will display the contents of a record from the WF_TRANSITION table and allow it to be updated. 
...
('wf_workflow(add)', 'This will allow a new record to be added to the WF_WORKFLOW table.
...
('wf_workflow(upd)', 'This will display the contents of a record from the WF_WORKFLOW table and allow it to be updated. 

Refer to <a href=\"%root%/wf_workflow(upd).html\">Update Workflow Process</a> for full details.', '2005-07-02 17:05:57', 'AJM', NULL, NULL),
('wf_workitem(enq)', 'This will display the contents of a record from the WF_WORKITEM table.

Refer to <a href=\"%root%/wf_workitem(enq).html\">Enquire Workflow Workitem</a> for full details.', '2005-07-02 16:57:44', 'AJM', NULL, NULL),
('wf_workitem(list)', 'This will list records on the WF_WORKITEM table.

Refer to <a href=\"%root%/wf_workitem(list).html\">List Workflow Workitem</a> for full details.', '2005-07-02 15:50:35', 'AJM', NULL, NULL),
('wf_workitem(list)2', 'This will list records on the WF_WORKITEM table for a selected WORKFLOW CASE.
...
('wf_workitem(search)', 'This will allow search criteria to be entered for the WF_WORKITEM table.
