...
$inner_sql_select = 'dict_table.table_id, dict_table.table_desc, count(dict_column.table_id) as column_count';
...
$inner_sql_groupby = 'dict_table.table_id, dict_table.table_desc';

// activate page controller
require 'std.list2.popup.inc';
