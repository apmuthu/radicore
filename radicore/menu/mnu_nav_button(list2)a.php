...
$outer_table = 'mnu_task_jnr';                       // name of outer (parent) table
$inner_table = 'mnu_nav_button_snr';                 // name of inner (child) table
$screen      = 'mnu_nav_button.list2a.screen.inc';   // file identifying screen structure
