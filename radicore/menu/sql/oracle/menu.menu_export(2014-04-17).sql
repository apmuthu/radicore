SALTER SESSION SET NLS_DATE_FORMAT = 'YYYY-MM-DD HH24:MI:SS';
...
('User Role' ,'2014-04-19 09:28:26' ,'AJM' ,'N' ,'N' ,'N' ,'LIST2' ,'mnu_user_role(list2).php' ,'MENU' ,'List User Role by User' ,'mnu_user_role(list2)' ,'PROC' ,'N');
