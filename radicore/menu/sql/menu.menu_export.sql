-- file created on December 2, 2008, 10:21 am
...
REPLACE INTO `mnu_language` (`language_id`, `language_name`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES ('ES', 'Spanish (Spain) [es]', '2008-01-03 16:14:15', 'AJM', NULL, NULL);
REPLACE INTO `mnu_language` (`language_id`, `language_name`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES ('FR', 'French (France) [fr]', '2008-01-03 16:13:31', 'AJM', NULL, NULL);
...
REPLACE INTO `mnu_role` (`role_id`, `role_desc`, `start_task_id`, `global_access`, `is_external_auth_off`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES ('DEMO', 'Demonstration Class', 'order', 'N', 'N', '2003-01-01 12:00:00', 'AJM', '2008-05-28 21:11:58', 'AJM');
...
REPLACE INTO `mnu_task` (`task_id`, `task_desc`, `button_text`, `task_type`, `script_id`, `is_disabled`, `pattern_id`, `subsys_id`, `initial_passthru`, `selection_fixed`, `selection_temp`, `settings`, `order_by`, `keep_data`, `log_sql_query`, `screen_refresh`, `use_https`, `max_execution_time`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES ('batch_log(filedownload)', 'Download Batch Log File', 'Batch Log Files', 'PROC', 'batch_log_filedownload.php', 'N', 'FILEDOWNLOAD', 'MENU', NULL, NULL, NULL, NULL, NULL, 'N', 'N', NULL, 'N', NULL, '2008-11-21 11:42:41', 'AJM', NULL, NULL);

REPLACE INTO `mnu_task` (`task_id`, `task_desc`, `button_text`, `task_type`, `script_id`, `is_disabled`, `pattern_id`, `subsys_id`, `initial_passthru`, `selection_fixed`, `selection_temp`, `settings`, `order_by`, `keep_data`, `log_sql_query`, `screen_refresh`, `use_https`, `max_execution_time`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES ('batch_log(filepicker)', 'Show Batch Log File', 'Batch Log Files', 'PROC', 'batch_log_filepicker.php', 'N', 'FILEPICKER', 'MENU', NULL, NULL, NULL, 'hyperlink_direct=Y', NULL, 'N', 'N', '10', 'N', NULL, '2008-11-21 12:09:14', 'AJM', '2008-12-02 10:20:18', 'AJM');

REPLACE INTO `mnu_nav_button` (`task_id_snr`, `task_id_jnr`, `sort_seq`, `button_text`, `context_preselect`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES ('batch_log(filepicker)', 'file(search)', '001', 'Search', 'N', '2008-11-22 16:20:27', 'AJM', NULL, NULL);
REPLACE INTO `mnu_nav_button` (`task_id_snr`, `task_id_jnr`, `sort_seq`, `button_text`, `context_preselect`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES ('batch_log(filepicker)', 'file(delete)', '002', 'Delete', 'Y', '2008-11-24 16:34:42', 'AJM', NULL, NULL);
...
REPLACE INTO `mnu_task_field` (`task_id`, `field_id`, `field_desc`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES ('mnu_control(upd3)', 'RADIUS_AUTHENTICATION', NULL, '2008-01-31 18:47:17', 'AJM', NULL, NULL);
...
REPLACE INTO `mnu_role_task` (`role_id`, `task_id`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES ('READONLY', 'mnu_control(upd3)', '2003-01-01 12:00:00', 'AJM', '2007-09-10 10:44:32', 'AJM');
...
REPLACE INTO `mnu_role_taskfield` (`role_id`, `task_id`, `field_id`, `access_type`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES ('READONLY', 'mnu_control(upd3)', 'RADIUS_AUTHENTICATION', 'NED', '2008-01-31 18:48:16', 'AJM', NULL, NULL);
...
REPLACE INTO `mnu_nav_button` (`task_id_snr`, `task_id_jnr`, `sort_seq`, `button_text`, `context_preselect`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES ('mnu_nav_button(list2)a', 'mnu_nav_button(del2)', '002', 'Delete', 'Y', '2007-08-12 14:28:49', 'AJM', NULL, NULL);
...
REPLACE INTO `mnu_nav_button` (`task_id_snr`, `task_id_jnr`, `sort_seq`, `button_text`, `context_preselect`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES ('mnu_nav_button(list2)a', 'mnu_nav_button(add3)a', '001', 'New', 'N', '2007-08-12 14:29:06', 'AJM', '2007-08-12 18:55:55', 'AJM');
REPLACE INTO `mnu_nav_button` (`task_id_snr`, `task_id_jnr`, `sort_seq`, `button_text`, `context_preselect`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES ('mnu_nav_button(list2)a', 'mnu_nav_button(del2)', '002', 'Delete', 'Y', '2007-08-12 14:28:49', 'AJM', NULL, NULL);
REPLACE INTO `mnu_nav_button` (`task_id_snr`, `task_id_jnr`, `sort_seq`, `button_text`, `context_preselect`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES ('mnu_nav_button(list2)a', 'mnu_nav_button(search)', '003', 'Search', 'N', '2007-08-12 14:28:24', 'AJM', '2007-08-12 14:29:17', 'AJM');
...
REPLACE INTO `mnu_task` (`task_id`, `task_desc`, `button_text`, `task_type`, `script_id`, `is_disabled`, `pattern_id`, `subsys_id`, `initial_passthru`, `selection_fixed`, `selection_temp`, `settings`, `order_by`, `keep_data`, `log_sql_query`, `screen_refresh`, `use_https`, `max_execution_time`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES ('mnu_pattern(enq1)', 'Enquire Pattern', 'Enquire', 'PROC', 'mnu_pattern_enq.php', 'N', 'ENQ1', 'MENU', NULL, NULL, NULL, NULL, NULL, 'N', 'N', NULL, 'N', NULL, '2004-01-01 00:00:00', 'AJM', '2007-09-10 11:03:25', 'AJM');
...
REPLACE INTO `mnu_task` (`task_id`, `task_desc`, `button_text`, `task_type`, `script_id`, `is_disabled`, `pattern_id`, `subsys_id`, `initial_passthru`, `selection_fixed`, `selection_temp`, `settings`, `order_by`, `keep_data`, `log_sql_query`, `screen_refresh`, `use_https`, `max_execution_time`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES ('mnu_role(search)', 'Search Role', 'Search', 'PROC', 'mnu_role_search.php', 'N', 'SRCH', 'MENU', NULL, NULL, NULL, NULL, NULL, 'N', NULL, NULL, 'N', NULL, '2004-01-01 00:00:00', 'AJM', NULL, NULL);
...
REPLACE INTO `mnu_nav_button` (`task_id_snr`, `task_id_jnr`, `sort_seq`, `button_text`, `context_preselect`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES ('mnu_task(list1)', 'audit_dtl(list)3', '024', 'Audit Trail', 'Y', '2004-04-09 11:38:19', 'AJM', '2007-09-10 14:30:48', 'AJM');
...
REPLACE INTO `mnu_nav_button` (`task_id_snr`, `task_id_jnr`, `sort_seq`, `button_text`, `context_preselect`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES ('mnu_task(list1)a', 'audit_dtl(list)3', '021', 'Audit Trail', 'Y', '2004-04-09 11:38:58', 'AJM', '2007-09-10 14:35:24', 'AJM');
...
REPLACE INTO `mnu_nav_button` (`task_id_snr`, `task_id_jnr`, `sort_seq`, `button_text`, `context_preselect`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES ('mnu_user(list1)', 'audit_dtl(list)3', '011', 'Audit Trail', 'Y', '2004-04-09 11:39:20', 'AJM', '2007-09-10 15:25:13', 'AJM');
...
REPLACE INTO `mnu_control` (`record_id`, `field_id`, `field_value`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES ('SYSTEM', 'AUTHENTICATION', 'INTERNAL', '2008-01-22 14:22:40', 'AJM', '2008-09-19 10:39:54', 'AJM');
...
REPLACE INTO `mnu_control` (`record_id`, `field_id`, `field_value`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES ('SYSTEM', 'LOGIN_TYPE', 'USER', '2008-10-05 14:53:39', 'AJM', '2008-11-17 17:49:47', 'AJM');
...
REPLACE INTO `mnu_control` (`record_id`, `field_id`, `field_value`, `created_date`, `created_user`, `revised_date`, `revised_user`) VALUES ('SYSTEM', 'PSWD_ENCRYPT', 'Y', '2003-01-01 12:00:00', 'AJM', '2007-10-31 14:46:25', 'AJM');
