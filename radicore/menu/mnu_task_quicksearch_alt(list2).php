...
$outer_table = 'mnu_task_quicksearch';                     // name of outer (parent) table
$inner_table = 'mnu_task_quicksearch_alt';                     // name of inner (child) table
$screen      = 'mnu_task_quicksearch_alt.list2.screen.inc';    // file identifying screen structure
