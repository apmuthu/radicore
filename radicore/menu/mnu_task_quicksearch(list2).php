...
$outer_table = 'mnu_task';                     // name of outer (parent) table
$inner_table = 'mnu_task_quicksearch';                     // name of inner (child) table
$screen      = 'mnu_task_quicksearch.list2.screen.inc';    // file identifying screen structure
