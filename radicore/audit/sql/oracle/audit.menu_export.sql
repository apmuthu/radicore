-- file created on May 19, 2016, 6:45 pm
...
INSERT INTO mnu_subsystem (subsys_id, subsys_name, subsys_dir, task_prefix, created_date, created_user, revised_date, revised_user) VALUES ('AUDIT', 'Audit Trail', 'audit', 'audit_', '2003-01-01 12:00:00', 'AJM', '2006-04-22 09:38:17', 'AJM');

INSERT INTO mnu_role (role_id, role_name, start_task_id, global_access, is_external_auth_off, created_date, created_user, revised_date, revised_user) VALUES ('AUDIT', 'AUDIT', 'main_menu', 'N', 'N', '2014-04-19 12:21:39', 'AJM', NULL, NULL);

INSERT INTO mnu_task (task_id, task_name, button_text, task_type, script_id, is_disabled, pattern_id, subsys_id, initial_passthru, selection_fixed, selection_temp, settings, order_by, keep_data, log_sql_query, screen_refresh, use_https, max_execution_time, task_id_run_at_end, task_id_run_at_cancel, created_date, created_user, revised_date, revised_user) VALUES ('audit_dtl(del)', 'Delete Audit Detail', 'Delete', 'PROC', 'audit_dtl_del.php', 'N', 'DEL4', 'AUDIT', NULL, NULL, NULL, NULL, NULL, 'N', 'N', NULL, 'N', NULL, NULL, NULL, '2006-03-20 15:29:33', 'AJM', '2006-03-20 16:50:22', 'AJM');
