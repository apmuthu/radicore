...
$outer_table = 'x_tree_node';                       // name of outer (parent) table
$inner_table = 'x_tree_node_alt';                   // name of inner (child) table
$screen      = 'tree_node_alt.list2.screen.inc';    // file identifying screen structure
