...
$outer_table = 'x_option';                     // name of outer (parent) table
$inner_table = 'x_option_alt';                     // name of inner (child) table
$screen      = 'x_option_alt.list2.screen.inc';    // file identifying screen structure
